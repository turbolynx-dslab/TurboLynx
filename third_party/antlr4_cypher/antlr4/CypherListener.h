...
public:
  ...
  virtual void enterOC_ReduceExpression(CypherParser::OC_ReduceExpressionContext *ctx) = 0;
  virtual void exitOC_ReduceExpression(CypherParser::OC_ReduceExpressionContext *ctx) = 0;
