...
// icecream::ic.enable(); IC(); icecream::ic.disable();
	context.client->graph_store->InitializeEdgeIndexSeek(state.ext_it, chunk, input, nodeColIdx, labels, empty_els, LoadAdjListOption::NONE, propertyKeys, targetTypes, target_eids, boundary_position);
// icecream::ic.enable(); IC(); icecream::ic.disable();
