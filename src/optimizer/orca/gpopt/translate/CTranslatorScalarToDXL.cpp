...
// #include "optimizer/orca/gpopt/translate/CCTEListEntry.h"
												  ...
												  IMDId *base_mdid)
{
	...
	else
	{
		...
		{
			if (mdid->Equals(&CMDIdGPDB::m_mdid_turbolynx_ubigint) ||
				mdid->Equals(&CMDIdGPDB::m_mdid_turbolynx_bigint) ||
				mdid->Equals(&CMDIdGPDB::m_mdid_turbolynx_id)) {
