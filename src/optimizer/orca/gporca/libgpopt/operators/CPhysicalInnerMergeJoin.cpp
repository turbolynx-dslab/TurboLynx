...
//
//	@filename:
//		CPhysicalInnerMergeJoin.cpp
//
//	@doc:
//		Implementation of inner merge join operator
//---------------------------------------------------------------------------
...
CDistributionSpec *
CPhysicalInnerMergeJoin::PdsRequired(CMemoryPool * /*mp*/,
									...
									ULONG /*ulOptReq*/) const
{
	GPOS_RAISE(
		...
		GPOS_WSZ_LIT(
			"PdsRequired should not be called for CPhysicalInnerMergeJoin"));
	return NULL;
}

CEnfdDistribution *
CPhysicalInnerMergeJoin::Ped(CMemoryPool *mp, CExpressionHandle &exprhdl,
...
COrderSpec *
CPhysicalInnerMergeJoin::PosRequired(CMemoryPool *mp,
									CExpressionHandle &,  //exprhdl,
									COrderSpec *,		  //posInput
									ULONG child_index,
									CDrvdPropArray *,  //pdrgpdpCtxt
...
CRewindabilitySpec *
CPhysicalInnerMergeJoin::PrsRequired(CMemoryPool *mp, CExpressionHandle &exprhdl,
...
CPhysicalInnerMergeJoin::EpetOrder(CExpressionHandle &, const CEnfdOrder *
#ifdef GPOS_DEBUG
														   peo
#endif	// GPOS_DEBUG
) const
...
CPhysicalInnerMergeJoin::Edm(CReqdPropPlan *,   // prppInput
							ULONG,			   // child_index,
							CDrvdPropArray *,  // pdrgpdpCtxt,
							ULONG			   // ulOptReq
)
...
CDistributionSpec *
CPhysicalInnerMergeJoin::PdsDerive(CMemoryPool *mp,
