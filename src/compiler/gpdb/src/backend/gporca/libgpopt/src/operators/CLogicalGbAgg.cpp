...
CLogicalGbAgg::PxfsCandidates(CMemoryPool *mp) const
{
	...
	//(void) xform_set->ExchangeSet(CXform::ExfSplitGbAgg); // S62 currently do not have stream agg
	...
	// (void) xform_set->ExchangeSet(CXform::ExfGbAgg2StreamAgg); // S62 currently do not have stream agg
