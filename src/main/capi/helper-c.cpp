...
LogicalTypeId ConvertCTypeToCPP(turbolynx_type c_type) {
	...
	case TURBOLYNX_TYPE_TIMESTAMP:
		return LogicalTypeId::TIMESTAMP;
	case TURBOLYNX_TYPE_DATE:
		return LogicalTypeId::DATE;
	case TURBOLYNX_TYPE_TIME:
		return LogicalTypeId::TIME;
	case TURBOLYNX_TYPE_VARCHAR:
		return LogicalTypeId::VARCHAR;
	case TURBOLYNX_TYPE_BLOB:
		return LogicalTypeId::BLOB;
	case TURBOLYNX_TYPE_INTERVAL:
		return LogicalTypeId::INTERVAL;
	case TURBOLYNX_TYPE_TIMESTAMP_S:
		return LogicalTypeId::TIMESTAMP_SEC;
	case TURBOLYNX_TYPE_TIMESTAMP_MS:
		return LogicalTypeId::TIMESTAMP_MS;
	case TURBOLYNX_TYPE_TIMESTAMP_NS:
		return LogicalTypeId::TIMESTAMP_NS;
	case TURBOLYNX_TYPE_UUID:
...
turbolynx_type ConvertCPPTypeToC(const LogicalType &sql_type) {
	switch (sql_type.id()) {
	case LogicalTypeId::BOOLEAN:
		return TURBOLYNX_TYPE_BOOLEAN;
	case LogicalTypeId::TINYINT:
		return TURBOLYNX_TYPE_TINYINT;
	case LogicalTypeId::SMALLINT:
		return TURBOLYNX_TYPE_SMALLINT;
	case LogicalTypeId::INTEGER:
		return TURBOLYNX_TYPE_INTEGER;
	case LogicalTypeId::BIGINT:
		return TURBOLYNX_TYPE_BIGINT;
	case LogicalTypeId::UTINYINT:
		return TURBOLYNX_TYPE_UTINYINT;
	case LogicalTypeId::USMALLINT:
		return TURBOLYNX_TYPE_USMALLINT;
	case LogicalTypeId::UINTEGER:
		return TURBOLYNX_TYPE_UINTEGER;
	case LogicalTypeId::UBIGINT:
		return TURBOLYNX_TYPE_UBIGINT;
	case LogicalTypeId::HUGEINT:
		return TURBOLYNX_TYPE_HUGEINT;
	case LogicalTypeId::FLOAT:
		return TURBOLYNX_TYPE_FLOAT;
	case LogicalTypeId::DOUBLE:
		return TURBOLYNX_TYPE_DOUBLE;
	case LogicalTypeId::TIMESTAMP:
	case LogicalTypeId::TIMESTAMP_TZ:
		return TURBOLYNX_TYPE_TIMESTAMP;
	case LogicalTypeId::TIMESTAMP_SEC:
		return TURBOLYNX_TYPE_TIMESTAMP_S;
	case LogicalTypeId::TIMESTAMP_MS:
		return TURBOLYNX_TYPE_TIMESTAMP_MS;
	case LogicalTypeId::TIMESTAMP_NS:
		return TURBOLYNX_TYPE_TIMESTAMP_NS;
	case LogicalTypeId::DATE:
		return TURBOLYNX_TYPE_DATE;
	...
	case LogicalTypeId::INTERVAL:
		return TURBOLYNX_TYPE_INTERVAL;
	case LogicalTypeId::DECIMAL:
		return TURBOLYNX_TYPE_DECIMAL;
	case LogicalTypeId::ENUM:
		return TURBOLYNX_TYPE_ENUM;
	case LogicalTypeId::LIST:
		return TURBOLYNX_TYPE_LIST;
	case LogicalTypeId::STRUCT:
		return TURBOLYNX_TYPE_STRUCT;
	case LogicalTypeId::MAP:
		return TURBOLYNX_TYPE_MAP;
...
idx_t GetCTypeSize(turbolynx_type type) {
	...
	case TURBOLYNX_TYPE_HUGEINT:
	case TURBOLYNX_TYPE_UUID:
		return sizeof(turbolynx_hugeint);
	case TURBOLYNX_TYPE_FLOAT:
		return sizeof(float);
	case TURBOLYNX_TYPE_DOUBLE:
		return sizeof(double);
	case TURBOLYNX_TYPE_DATE:
		return sizeof(turbolynx_date);
	case TURBOLYNX_TYPE_TIME:
		return sizeof(turbolynx_time);
	case TURBOLYNX_TYPE_TIMESTAMP:
	case TURBOLYNX_TYPE_TIMESTAMP_S:
	case TURBOLYNX_TYPE_TIMESTAMP_MS:
	case TURBOLYNX_TYPE_TIMESTAMP_NS:
		return sizeof(turbolynx_timestamp);
	case TURBOLYNX_TYPE_VARCHAR:
		return sizeof(const char *);
	case TURBOLYNX_TYPE_INTERVAL:
		return sizeof(turbolynx_interval);
