    ...
    for cost_model in "${cost_models[@]}"; do
        for layering_order in "${layering_orders[@]}"; do
            for zipf_value in "${zipf_values[@]}"; do
                output_file="basic_${cluster_algo}_${cost_model}_${layering_order}_zipf${zipf_value}.csv"
                ...
                for query_num in $queries; do
                    ...
                    log_file="${log_dir}/basic_Q${query_num}_${cluster_algo}_${cost_model}_${layering_order}_zipf${zipf_value}.txt"
