...
scale_factor=1
source_dir_base="/source-data/yago-tiny-converted"
...
for cluster_algo in "${cluster_algorithms[@]}"; do
    for cost_model in "${cost_models[@]}"; do
        for layering_order in "${layering_orders[@]}"; do
            ...
            log_file="${log_dir}/yago_${i}_${cluster_algo}_${cost_model}_${layering_order}.txt"
            /turbograph-v3/build-release/tbgpp-execution-engine/bulkload_using_map \
                ...
                --relationships:http://schema.org/neighbors ${source_dir}/edges_neighbors.csv \
                --relationships_backward:http://schema.org/neighbors ${source_dir}/edges_neighbors.csv.backward \
                ...
                --relationships:http://schema.org/administrates ${source_dir}/edges_administrates.csv \
                --relationships_backward:http://schema.org/administrates ${source_dir}/edges_administrates.csv.backward \
                ...
                --relationships:http://schema.org/ownedBy ${source_dir}/edges_ownedBy.csv \
                --relationships_backward:http://schema.org/ownedBy ${source_dir}/edges_ownedBy.csv.backward \
                --relationships:http://schema.org/influencedBy ${source_dir}/edges_influencedBy.csv \
                --relationships_backward:http://schema.org/influencedBy ${source_dir}/edges_influencedBy.csv.backward \
                ...
                --relationships:http://schema.org/highestPoint ${source_dir}/edges_highestPoint.csv \
                --relationships_backward:http://schema.org/highestPoint ${source_dir}/edges_highestPoint.csv.backward \
                --relationships:http://schema.org/leader ${source_dir}/edges_leader.csv \
                --relationships_backward:http://schema.org/leader ${source_dir}/edges_leader.csv.backward \
                ...
                --relationships:http://schema.org/lowestPoint ${source_dir}/edges_lowestPoint.csv \
                --relationships_backward:http://schema.org/lowestPoint ${source_dir}/edges_lowestPoint.csv.backward \
                --relationships:http://www.w3.org/ns/shacl#node ${source_dir}/edges_shacl#node.csv \
                --relationships_backward:http://www.w3.org/ns/shacl#node ${source_dir}/edges_shacl#node.csv.backward \
                ...
                --relationships:http://schema.org/officialLanguage ${source_dir}/edges_officialLanguage.csv \
                --relationships_backward:http://schema.org/officialLanguage ${source_dir}/edges_officialLanguage.csv.backward \
                ...
                --relationships_backward:http://yago-knowledge.org/resource/consumes ${source_dir}/edges_consumes.csv.backward &> ${log_file}
