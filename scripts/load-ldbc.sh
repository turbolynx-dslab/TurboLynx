...
/turbograph-v3/build-release/tools/turbolynx import \
    ...
    --relationships HAS_CREATOR         --relationships $DATA/dynamic/Post_hasCreator_Person.csv \
    --relationships IS_LOCATED_IN       --relationships $DATA/dynamic/Person_isLocatedIn_Place.csv \
    --relationships IS_LOCATED_IN       --relationships $DATA/dynamic/Comment_isLocatedIn_Place.csv \
    --relationships IS_LOCATED_IN       --relationships $DATA/dynamic/Post_isLocatedIn_Place.csv \
    --relationships IS_LOCATED_IN       --relationships $DATA/static/Organisation_isLocatedIn_Place.csv \
    ...
    --relationships LIKES               --relationships $DATA/dynamic/Person_likes_Post.csv \
    ...
    --relationships HAS_TAG             --relationships $DATA/dynamic/Forum_hasTag_Tag.csv \
    --relationships HAS_TAG             --relationships $DATA/dynamic/Post_hasTag_Tag.csv \
