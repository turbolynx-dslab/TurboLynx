...
//
//	@filename:
//		CLogicalAllShortestPathGet.h
//
//	@doc:
//		Basic table accessor
//---------------------------------------------------------------------------
#ifndef GPOPT_CLogicalAllShortestPathGet_H
#define GPOPT_CLogicalAllShortestPathGet_H
...
//---------------------------------------------------------------------------
//	@class:
//		CLogicalAllShortestPathGet
//
//	@doc:
//		Basic table accessor
//
//---------------------------------------------------------------------------
class CLogicalAllShortestPathGet : public CLogical
{
private:
	// alias for table
	...
	// private copy ctor
	CLogicalAllShortestPathGet(const CLogicalAllShortestPathGet &);

public:
	// ctors
	explicit CLogicalAllShortestPathGet(CMemoryPool *mp);

	CLogicalAllShortestPathGet(CMemoryPool *mp, const CName *pnameAlias,
	...
	// dtor
	virtual ~CLogicalAllShortestPathGet();

	// ident accessors
	virtual EOperatorId
	Eopid() const
	{
		return EopLogicalAllShortestPathGet;
	}
	...
	SzId() const
	{
		return "CLogicalAllShortestPathGet";
	}
	...
	{
		GPOS_ASSERT(!"CLogicalAllShortestPathGet has no children");
		return NULL;
	}
	...
	// conversion function
	static CLogicalAllShortestPathGet *
	PopConvert(COperator *pop)
	{
		GPOS_ASSERT(NULL != pop);
		GPOS_ASSERT(EopLogicalAllShortestPathGet == pop->Eopid() );

		return dynamic_cast<CLogicalAllShortestPathGet *>(pop);
	}

	// debug print
	virtual IOstream &OsPrint(IOstream &) const;

};	// class CLogicalAllShortestPathGet

}  // namespace gpopt


#endif	// !GPOPT_CLogicalAllShortestPathGet_H
