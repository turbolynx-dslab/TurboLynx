...
#define GPDB_BOOL_BASE_ID OID(1000000000) // S62 TODO remove this
#define GPDB_BOOL_OID (GPDB_BOOL_BASE_ID + OID(16))
...
#define GPDB_BOOL_EQ_OP (GPDB_BOOL_BASE_ID + OID(91))
#define GPDB_BOOL_NEQ_OP (GPDB_BOOL_BASE_ID + OID(85))
#define GPDB_BOOL_LT_OP (GPDB_BOOL_BASE_ID + OID(58))
#define GPDB_BOOL_LEQ_OP (GPDB_BOOL_BASE_ID + OID(1694))
#define GPDB_BOOL_GT_OP (GPDB_BOOL_BASE_ID + OID(59))
#define GPDB_BOOL_GEQ_OP (GPDB_BOOL_BASE_ID + OID(1695))
#define GPDB_BOOL_COMP_OP (GPDB_BOOL_BASE_ID + OID(1693))
#define GPDB_BOOL_ARRAY_TYPE (GPDB_BOOL_BASE_ID + OID(1000))
#define GPDB_BOOL_AGG_MIN OID(0)
#define GPDB_BOOL_AGG_MAX OID(0)
#define GPDB_BOOL_AGG_AVG OID(0)
#define GPDB_BOOL_AGG_SUM OID(0)
#define GPDB_BOOL_AGG_COUNT (GPDB_BOOL_BASE_ID + OID(2147))
