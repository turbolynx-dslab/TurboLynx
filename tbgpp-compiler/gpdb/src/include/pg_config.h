...
#define GP_VERSION "6.23.0 build dev"
...
#define PG_VERSION_STR "PostgreSQL 9.4.26 (Greenplum Database 6.23.0 build dev) on x86_64-unknown-linux-gnu, compiled by gcc (Ubuntu 7.5.0-3ubuntu1~18.04) 7.5.0, 64-bit"
