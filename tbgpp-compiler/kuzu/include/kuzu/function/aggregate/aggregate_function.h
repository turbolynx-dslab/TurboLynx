...
using aggr_initialize_function_t = std::function<void(void)>;
using aggr_update_all_function_t = std::function<void(void)>;
using aggr_update_pos_function_t = std::function<void(void)>;
using aggr_combine_function_t = std::function<void(void)>;
using aggr_finalize_function_t = std::function<void(void)>;

static std::function<void(void)> empty_agg_func() { return []() -> void { return; } ; }
